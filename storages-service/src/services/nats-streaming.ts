...
import { setUserCreatedListener, setUserEditedListener, setTeamCreatedListener, setTeamAcceptedListener, setTeamRemovedListener } from "../events/listeners";
...
export const connectToNatsStreaming = async () => {
    try {
        const qGroupName = "storages-service";
